...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { title, description, frequency, color, icon, background_image } = req.body;
...
router.put('/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { title, description, frequency, color, icon, is_active, background_image } = req.body;

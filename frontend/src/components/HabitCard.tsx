...
export default function HabitCard({ habit, onToggleActive, onDelete, onEdit }: HabitCardProps) {
  ...
  return (
    <div
      className={`relative bg-white rounded-xl border transition-all ${
        habit.is_active ? 'border-neutral-200 shadow-sm' : 'border-neutral-200 opacity-60'
      }`}
    >
          ...
          <div className="flex items-center gap-1">
            ...
            >
              {habit.is_active ? (
                ...
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.196-2.131A1 1 0 0110 10.07v3.86a1 1 0 011.552.894l3.196-2.131a1 1 0 000-1.786zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              )}
            </button>
